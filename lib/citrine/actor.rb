...
module Citrine
  class Actor
    ...
    class << self
      def enable_async_io; include Celluloid::IO; end
      def enable_notifications; include Celluloid::Notifications; end
      def [](name); Celluloid::Actor[name]; end
      def registered; Celluloid::Actor.registered; end
