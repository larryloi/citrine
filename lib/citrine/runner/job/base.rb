  ...
  module Runner
    module Job
      class Base
        ...
        def initialize(id:, worker:, operation: default_operation, runner:, auto_start: default_auto_start, **opts)
          @id = id
        ...
        def default_start_after; 0; end
        def default_auto_start; true; end
        ...
        def reset_result; @result = nil; end
        def reset_states; end
        def reset_stats; @stats = {}; end
