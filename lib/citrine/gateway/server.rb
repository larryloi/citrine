  ...
  module Gateway
    class Server < Reel::Server::HTTP
      ...
      def route_request(request)
        ...
        status, headers, body = router.call ::Rack::MockRequest.env_for(request.url, env)
